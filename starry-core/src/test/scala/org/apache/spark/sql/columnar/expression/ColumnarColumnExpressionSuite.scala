...
class ColumnarColumnExpressionSuite extends QueryTest with ColumnarExpressionEvalHelper {
  ...
  override protected def test(testName: String, testTags: Tag*)(testFun: => Any)(
    ...
    val ignores = Seq(
      "SPARK-31553: isInCollection - collection element types",
      "input_file_name, input_file_block_start, input_file_block_length - more than one source",
      "input_file_name, input_file_block_start, input_file_block_length - NewHadoopRDD",
      "SPARK-34721: add a year-month interval to a date",
      "SPARK-34739: add a year-month interval to a timestamp",
      "SPARK-34761, SPARK-34903: add/subtract a day-time interval to/from a timestamp",
      "SPARK-34903: Return day-time interval from timestamps subtraction",
      "SPARK-35051: add/subtract a day-time interval to/from a date",
      "SPARK-35852: add/subtract a interval day to/from a date")
