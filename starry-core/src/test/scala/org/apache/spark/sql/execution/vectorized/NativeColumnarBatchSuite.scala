...
class NativeColumnarBatchSuite extends SparkFunSuite with ColumnarSharedSparkSession {
...
//      val str = "string"
//      column.putByteArray(column.elementsAppended, str.getBytes(StandardCharsets.UTF_8),
...
//        assert(v._1.length == column.getUTF8String(v._2), errMsg)
