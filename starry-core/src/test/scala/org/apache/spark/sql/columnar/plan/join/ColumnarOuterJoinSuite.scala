...
import org.apache.spark.sql.execution.joins.{InnerJoinSuite, OuterJoinSuite}
import org.scalactic.source.Position
import org.scalatest.Tag

class ColumnarOuterJoinSuite extends OuterJoinSuite with ColumnarSharedSparkSession {
